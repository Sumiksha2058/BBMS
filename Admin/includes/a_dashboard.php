    ...
    <div class="container-fluid">
            <div class="row gx-6">
                <div class="col" id="dashbord">
                    ...
                    <div class="col shadow  mb-3 rounded  text-center">
                        <h1 class="fs-4 text-light">
                            ...
                            <span class="ms-2  d-none d-md-inline fs-2 title">Dashboard</span>
                        </h1>
                    </div>
                    <div class="col md-text-center">
                        <ul class="nav nav-tabs fs-4 flex-column" role="tablist">
                            ...
                            <li class="nav-item mb-3">
                                <a href="index.php" class="nav-link text-light" id="nav-link" data-bs-toggle="tooltip">
                            ...
                            <li class="nav-item mb-3">
                                <a href="user.php" class="nav-link text-light pb-2" id="nav-link" data-bs-toggle="tooltip">
                                    <i class="fa fa-clipboard d-inline d-xl-none d-md-none text-center"
                                        ...
                                        aria-hidden="false"></i>
                                    <strong class="ms-2 d-none d-md-inline">Users</strong>
                                </a>
                            </li>
                            ...
                            <li class="nav-item mb-3">
                                <a href="recivers.php" class="nav-link text-light pb-2" id="nav-link" data-bs-toggle="tooltip">
                                    ...
                                    <strong class="ms-2 d-none d-md-inline">Recevers</strong>
                                </a>
                            </li>
                            <li class="nav-item mb-3">
                            ...
                            <li class="nav-item mb-3">
                                <a href="request.php" class="nav-link text-light pb-2" id="nav-link" data-bs-toggle="tooltip">
                                    <i class="fa fa-key d-inline d-xl-none d-md-none" data-bs-toggle="tooltip"
                                        data-bs-placement="right" title="Change Password" aria-hidden="false"></i>
                                    <strong class="ms-2 d-none d-md-inline">Request</strong >
                                </a>
                            </li>
                        </ul>
                    </div>
