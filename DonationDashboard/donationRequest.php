...
$reason = $_POST["reason"]; $amountRequested =

$_POST["amount_requested"];

// Insert data into the donation request table

$sql = "INSERT INTO donation_requests (requester_name, contact_info, reason,

amount_requested) VALUES ('$requesterName',
...
if ($conn->query($sql) === TRUE) { echo "Donation request submitted successfully!";
...
isset($_POST["admin_password"]) { $adminUsername =
