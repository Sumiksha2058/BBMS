                    ...
                    <div class="col md-text-center">
                        <ul class="nav nav-tabs fs-5 flex-column" role="tablist">
                            ...
                            <li class="nav-item mb-4">
                                <a href="Dprofile.php" class="nav-link text-light" id="nav-link" data-bs-toggle="tooltip">
                            ...
                            <li class="nav-item mb-4">
                                <a href="#" class="nav-link text-light pb-2" id="nav-link" data-bs-toggle="tooltip">
                            ...
                            <li class="nav-item mb-4">
                                <a href="Dchangepassword.php" class="nav-link text-light pb-2" id="nav-link" data-bs-toggle="tooltip">
